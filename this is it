...
# ---------- CONFIG ----------
st.set_page_config(page_title="🎬 YouTube Window", layout="centered")

st.title("🎬 YouTube Window: Watch & Explore")
st.caption("Paste a YouTube URL to see metadata and watch the video inside the app. !")
